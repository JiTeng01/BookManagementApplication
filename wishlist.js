...
export default class MainActivity extends Component {
    ...
    constructor(props) {
      ...
      _load(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/myWishlist.php',{
          method: 'POST',
          headers: {
      ...
      _loadAsc(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/wishlist(ASC).php',{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
      ...
      _loadDesc(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/wishlist(DESC).php',{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
      ...
      _loadDateAsc(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/wishlist(DATE_ASC).php',{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
      ...
      _loadDateDesc(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/wishlist(DATE_DESC).php',{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
      ...
      _loadAuthorAsc(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/wishlist(AUTHOR_ASC).php',{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
      ...
      _loadAuthorDesc(){
        return fetch('https://bookmanagementapplication.000webhostapp.com/wishlist(AUTHOR_DESC).php',{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    if (book)
    {
      ...
      render() {
        ...
        enableEmptySections={true}
          ...
          renderRow={(book)=>
            <TouchableHighlight onPress={() => {
                this.props.navigation.navigate('WishlistResult',{book:book, UserId:this.props.navigation.state.params.UserId,refresh:()=>this._load()})
              }}>
                <View style={styles.row}>
                  <Image style={styles.thumb} source={{uri: book.image}} />
                  <View style={styles.bookInfo}>
