...
export default class SecondActivity extends Component {
  ...
  _load() {
    return fetch('https://bookmanagementapplication.000webhostapp.com/bookstoreresult.php', {
      method: 'POST',
      headers: {
  ...
  DeleteRecord = () => {
    Alert.alert('Alert', 'Are you sure you want to delete?', [
      ...
      },
      {
        text: 'Yes',
        onPress: () => {
          fetch('https://bookmanagementapplication.000webhostapp.com/deletebookstore.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
  ...
  render() {
    return (
      ...
      />
          ...
          <Button style={styles.buttonStyle3}   onPress={() => { this.props.navigation.navigate('Editbookstore', {book:this.state.book, UserId:this.props.navigation.state.params.UserId})}}>
            <View>
