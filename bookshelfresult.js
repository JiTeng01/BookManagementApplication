...
export default class SecondActivity extends Component {
  ...
  _load() {
    return fetch('https://bookmanagementapplication.000webhostapp.com/bookshelfresult.php', {
      method: 'POST',
      headers: {
  ...
  DeleteRecord = () => {
    Alert.alert('Alert', 'Are you sure you want to delete?', [
      ...
      },
      {
        text: 'Yes',
        onPress: () => {
          fetch('https://bookmanagementapplication.000webhostapp.com/delete.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
...
AddToBookstore = () =>{
  Alert.alert('Alert', 'Are you sure you want to add it to your bookstore?',[
    {
      text:'No',
      onPress:()=>{},
    },
    {
      ...
      onPress:()=>{
        this.setState({ ActivityIndicator_Loading : true }, () =>
         {
          fetch('https://bookmanagementapplication.000webhostapp.com/exchange_sell.php',
             {
                 method: 'POST',
                 headers:
                 {
  ...
  render() {
    return (
      ...
      />
          ...
          <Button style={styles.buttonStyle3}  onPress={() => { this.props.navigation.navigate('Edit', {book:this.state.book, UserId:this.props.navigation.state.params.UserId})}}>
            <View>
          ...
          <Button style={styles.buttonStyle4}  onPress={this.AddToBookstore}>
            <View>
              <Text style={styles.textStyle}>Add to My Bookstore</Text>
            </View>
          </Button>
